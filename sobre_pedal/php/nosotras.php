...
<body class="fondo" >
	...
	<div class="jumbotron login animated zoomIn delay-0s " >
		...
		<div class="texto">
			...
			<h2>QUIENES SOMOS</h2>
			<br>
			<p>dh csdh hdhcldhdslvhldhvlh h 
				dsj  djcldjscjdscj ds
				dc hsdkch  kdsh ck sdhchdschs
				c hschsl hclshlchls hclksdhclhs
			dshc skd hclksdhc, dkchdshc. </p>
		</div>

		<div class="imagenGif">
			<img src="../img/animacio_chachas_gif.gif" width="100%">
		</div>
